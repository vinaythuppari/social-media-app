        ...
        <div className='w-full'>
            <img onClick= {()=>navigate('/')} src={assets.logo} alt="logo" 
             ...
             <MenuItems setSidebarOpen={setSidebarOpen}/>
              ...
              rounded-lg bg-gradient-to-r from-indigo-500 to-purple-600 hover:from-indigo-700 hover:
              to-purple-800 active:scale-95 transition text-white cursor-pointer'>
