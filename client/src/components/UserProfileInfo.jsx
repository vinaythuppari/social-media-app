        ...
        <div className='flex flex-col md:flex-row items-start gap-6'>
            ...
            <div className='w-full pt-16 md:pt-0 md:pl-36'>
              <div className='flex flex-col md:flex-row items-start justify-between'> 
                ...
                {/* if user is not on others profoile that means he is opening his profile
                so we will give edit button */}
                {!profileId &&
                  <button onClick={()=>setShowEdit(true)}
                  className='flex items-center gap-2 border border-gray-300 hover:bg-gray-50 px-4
              ...
              <div className='flex items-center gap-6 mt-6 border-t border-gray-200 pt-4'>
                <div>
                  ...
                  <span className='tsxe-xs sm:text-sm  text-gray-500 ml-1.5'>Posts</span>
                </div>
                <div>
                  <span className='sm:text-xl font-bold text-gray-900'>{user.followers.length}</span>
                  <span className='tsxe-xs sm:text-sm  text-gray-500 ml-1.5'>Followers</span>
                </div>
                <div>
                  <span className='sm:text-xl font-bold text-gray-900'>{user.following.length}</span>
                  <span className='tsxe-xs sm:text-sm  text-gray-500 ml-1.5'>Following</span>
                </div>
              </div>
