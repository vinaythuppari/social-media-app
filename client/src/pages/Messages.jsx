        ...
        {/* title */}
          ...
          <div className='flex flex-col gap-3'>
            {dummyConnectionsData.map((user)=>(
              <div key={user._id} className='max-w-xl flex items-center gap-5 p-6 bg-white shadow rounded-md'>
                <img src={user.profile_picture} alt="user pic" className='rounded-full w-12 h-12 mx-auto'/>
